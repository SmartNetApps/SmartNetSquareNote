...
Public Class UpdateAgent
    ...
    Public Shared Function IsUpdateAvailable() As UpdateStatus
        Try
            ...
            Dim MiniNTVersion As Version = New Version(MAJ.DownloadString("https://smartnetapps.quentinpugeat.fr/updater/squarenote/windows/MinimumNTVersion.txt"))

            Dim VersionActuelle As Version = My.Application.Info.Version
            Dim DerniereVersion As Version = New Version(MAJ.DownloadString("https://smartnetapps.quentinpugeat.fr/updater/squarenote/windows/version.txt"))

            Dim SupportStatus As String = MAJ.DownloadString("https://smartnetapps.quentinpugeat.fr/updater/squarenote/windows/support-status.txt")
    ...
    Public Shared Function LastVersionNumberAvailable() As String
        Try
            Dim MAJ As New WebClient()
            Return MAJ.DownloadString("https://smartnetapps.quentinpugeat.fr/updater/squarenote/windows/version.txt")
        Catch ex As Exception
            Throw New Exception("La connexion à SmartNet Apps Updater a échoué.", ex)
            Return Nothing
        End Try
    ...
    Public Shared Function DownloadLink() As String
        Try
            Dim MAJ As New WebClient()
            Return MAJ.DownloadString("https://smartnetapps.quentinpugeat.fr/updater/squarenote/windows/download.txt")
        Catch ex As Exception
            Throw New Exception("La connexion à SmartNet Apps Updater a échoué.", ex)
            Return Nothing
        End Try
    ...
    Public Shared Function ReleaseNotes() As String
        Try
            Dim MAJ As New WebClient
            Return MAJ.DownloadString("https://smartnetapps.quentinpugeat.fr/updater/squarenote/windows/releasenotes.txt")
        Catch ex As Exception
            Throw New Exception("La connexion à SmartNet Apps Updater a échoué.", ex)
            Return Nothing
        End Try
